...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9M33fUm2nS', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0Fz8U9GTWk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'lessentielle', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vwGjhtrEIM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ug4Wegpjpe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ARAiWWLwWO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JcZkQEB6xMB0db0eSNz2E1BO73zDuGBJBksHKdF8tOkZAQpXvJsnZxshG1a24S8m'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JcZkQEB6xMB0db0eSNz2E1BO73zDuGBJBksHKdF8tOkZAQpXvJsnZxshG1a24S8m');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                54 => ($this->targetDirs[3].'/modules/tvcmscategorychainslider/translations'),
                55 => ($this->targetDirs[3].'/modules/tvcmscategoryproduct/translations'),
                56 => ($this->targetDirs[3].'/modules/tvcmscustomcssjs/translations'),
                57 => ($this->targetDirs[3].'/modules/tvcmscustomerservices/translations'),
                58 => ($this->targetDirs[3].'/modules/tvcmscustomsetting/translations'),
                59 => ($this->targetDirs[3].'/modules/tvcmsfooterlogo/translations'),
                60 => ($this->targetDirs[3].'/modules/tvcmsfooterproduct/translations'),
                61 => ($this->targetDirs[3].'/modules/tvcmspaymenticon/translations'),
                62 => ($this->targetDirs[3].'/modules/tvcmsstockinfo/translations'),
                63 => ($this->targetDirs[3].'/modules/tvcmstabproducts/translations'),
                64 => ($this->targetDirs[3].'/modules/tvcmscategoryslider/translations'),
                65 => ($this->targetDirs[3].'/modules/tvcmswishlist/translations'),
                66 => ($this->targetDirs[3].'/modules/tvcmsinfinitescroll/translations'),
                67 => ($this->targetDirs[3].'/modules/tvcmsfootercategory/translations'),
                68 => ($this->targetDirs[3].'/modules/tvcmscookiesnotice/translations'),
                69 => ($this->targetDirs[3].'/modules/tvcmsproductcomments/translations'),
                70 => ($this->targetDirs[3].'/modules/tvcmsleftsideofferbanner/translations'),
                71 => ($this->targetDirs[3].'/modules/tvcmssizechart/translations'),
                72 => ($this->targetDirs[3].'/modules/tvcmsbrandlist/translations'),
                73 => ($this->targetDirs[3].'/modules/tvcmsproductpopup/translations'),
                74 => ($this->targetDirs[3].'/modules/tvcmsvideotab/translations'),
                75 => ($this->targetDirs[3].'/modules/tvcmstwoofferbanner/translations'),
                76 => ($this->targetDirs[3].'/modules/tvcmsmegamenu/translations'),
                77 => ($this->targetDirs[3].'/modules/tvcmstestimonial/translations'),
                78 => ($this->targetDirs[3].'/modules/tvcmsblog/translations'),
                79 => ($this->targetDirs[3].'/modules/tvcmsblogdisplayposts/translations'),
                80 => ($this->targetDirs[3].'/modules/tvcmsslider/translations'),
                81 => ($this->targetDirs[3].'/modules/tvcmsmultibanner1/translations'),
                82 => ($this->targetDirs[3].'/modules/tvcmsnewproducts/translations'),
                83 => ($this->targetDirs[3].'/modules/tvcmsproductcompare/translations'),
                84 => ($this->targetDirs[3].'/modules/tvcmssearch/translations'),
                85 => ($this->targetDirs[3].'/modules/tvcmsspecialproducts/translations'),
                86 => ($this->targetDirs[3].'/modules/tvcmsthemeoptions/translations'),
                87 => ($this->targetDirs[3].'/modules/ps_emailalerts/translations'),
                88 => ($this->targetDirs[3].'/modules/ps_brandlist/translations'),
                89 => ($this->targetDirs[3].'/modules/ps_supplierlist/translations'),
                90 => ($this->targetDirs[3].'/modules/tvcmsnewsletterpopup/translations'),
                91 => ($this->targetDirs[3].'/modules/tvcmsbestsellerproducts/translations'),
                92 => ($this->targetDirs[3].'/modules/tvcmsfeaturedproducts/translations'),
                93 => ($this->targetDirs[3].'/modules/wfmbandeau/translations'),
                94 => ($this->targetDirs[3].'/modules/wksampleproduct/translations'),
                95 => ($this->targetDirs[3].'/modules/pm_advancedcookiebanner/translations'),
                96 => ($this->targetDirs[3].'/modules/colissimo/translations'),
                97 => ($this->targetDirs[3].'/modules/iqitfreedeliverycount/translations'),
                98 => ($this->targetDirs[3].'/modules/thegiftcard/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                61 => 'blockreassurance',
                62 => 'ps_facetedsearch',
                63 => 'tvcmscategorychainslider',
                64 => 'tvcmscategoryproduct',
                65 => 'tvcmscustomcssjs',
                66 => 'tvcmscustomerservices',
                67 => 'tvcmscustomsetting',
                68 => 'tvcmsfooterlogo',
                69 => 'tvcmsfooterproduct',
                70 => 'tvcmspaymenticon',
                71 => 'tvcmsstockinfo',
                72 => 'tvcmstabproducts',
                73 => 'tvcmscategoryslider',
                74 => 'tvcmswishlist',
                75 => 'tvcmsinfinitescroll',
                76 => 'tvcmsfootercategory',
                77 => 'tvcmscookiesnotice',
                78 => 'tvcmsproductcomments',
                79 => 'tvcmsleftsideofferbanner',
                80 => 'tvcmssizechart',
                81 => 'tvcmsbrandlist',
                82 => 'tvcmsproductpopup',
                83 => 'tvcmsvideotab',
                84 => 'tvcmstwoofferbanner',
                85 => 'tvcmsmegamenu',
                86 => 'tvcmstestimonial',
                87 => 'tvcmsblog',
                88 => 'tvcmsblogdisplayposts',
                89 => 'tvcmsslider',
                90 => 'tvcmsmultibanner1',
                91 => 'tvcmsnewproducts',
                92 => 'tvcmsproductcompare',
                93 => 'tvcmssearch',
                94 => 'tvcmsspecialproducts',
                95 => 'tvcmsthemeoptions',
                96 => 'ps_emailalerts',
                97 => 'ps_brandlist',
                98 => 'ps_supplierlist',
                99 => 'tvcmsnewsletterpopup',
                100 => 'tvcmsbestsellerproducts',
                101 => 'tvcmsfeaturedproducts',
                102 => 'wfmbandeau',
                103 => 'wksampleproduct',
                104 => 'pm_advancedcookiebanner',
                105 => 'colissimo',
                106 => 'iqitfreedeliverycount',
                107 => 'thegiftcard',
            ],
            ...
            'kernel.secret' => 'JcZkQEB6xMB0db0eSNz2E1BO73zDuGBJBksHKdF8tOkZAQpXvJsnZxshG1a24S8m',
