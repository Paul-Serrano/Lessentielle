...
{block name='iqitfreedeliverycount_product'}
<div class="iqitfreedeliverycount iqitfreedeliverycount-product clearfix {if $hide}iqitfreedeliverycount-hidden{/if}">
<div class="fd-table">
