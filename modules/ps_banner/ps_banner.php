...
class Ps_Banner extends Module implements WidgetInterface
{
    ...
    public function uninstallPrestaShop16Module()
    {
        ...
        Configuration::updateValue('BANNER_TEXT', Configuration::getInt('BLOCKBANNER_TEXT'));
        Configuration::updateValue('BANNER_BTN_TEXT', Configuration::getInt('BLOCKBANNER_BTN_TEXT'));
    ...
    protected function installFixture($id_lang, $image = null)
    {
        ...
        $values['BANNER_TEXT'][(int) $id_lang] = '';
        $values['BANNER_BTN_TEXT'][(int) $id_lang] = '';
        ...
        Configuration::updateValue('BANNER_TEXT', $values['BANNER_TEXT']);
        Configuration::updateValue('BANNER_BTN_TEXT', $values['BANNER_BTN_TEXT']);
    }
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('BANNER_TEXT');
        Configuration::deleteByName('BANNER_BTN_TEXT');
    ...
    public function postProcess()
    {
        if (Tools::isSubmit('submitStoreConf')) {
            ...
            foreach ($languages as $lang) {
                ...
                $values['BANNER_TEXT'][$lang['id_lang']] = Tools::getValue('BANNER_TEXT_' . $lang['id_lang']);
                $values['BANNER_BTN_TEXT'][$lang['id_lang']] = Tools::getValue('BANNER_BTN_TEXT_' . $lang['id_lang']);
            }
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        'type' => 'textarea',
                        'lang' => true,
                        'label' => $this->trans('Banner text', [], 'Modules.Banner.Admin'),
                        'name' => 'BANNER_TEXT',
                        'desc' => $this->trans('Please enter a short text to explain the purpose of this module.', [], 'Modules.Banner.Admin'),
                    ],
                    [
                        'type' => 'text',
                        'lang' => true,
    ...
    public function getConfigFieldsValues()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $fields['BANNER_TEXT'][$lang['id_lang']] = Tools::getValue('BANNER_TEXT_' . $lang['id_lang'], Configuration::get('BANNER_TEXT', $lang['id_lang']));
            $fields['BANNER_BTN_TEXT'][$lang['id_lang']] = Tools::getValue('BANNER_BTN_TEXT_' . $lang['id_lang'], Configuration::get('BANNER_BTN_TEXT', $lang['id_lang']));
        }
    ...
    public function getWidgetVariables($hookName, array $params)
    {
        ...
        return [
            ...
            'banner_text' => Configuration::get('BANNER_TEXT', $this->context->language->id),
            'banner_btn_text' => Configuration::get('BANNER_BTN_TEXT', $this->context->language->id),
        ];
    }
