...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class='container-fluid tvcmstestimonial tvcms-all-testimonial ' data-source-url="{$dis_arr_result['path']}{$main_heading.data.image}" style="background-image:url({$dis_arr_result['path']}{$main_heading.data.image})">
                ...
                <div class='tvtestimonial-content-box owl-theme owl-carousel'>
                    ...
                    <div class="item tvtestimonial-wrapper-info">
                        <div class="tvtestimonial-inner-content-box">
                            ...
                            <div class="tvtestimonial-image-title">
                                <div class="tvtestimonial-img-block">
                                        <img src='{$dis_arr_result["path"]}{$data["image"]}' class="tv-img-responsive" loading="lazy" />
                                </div>
