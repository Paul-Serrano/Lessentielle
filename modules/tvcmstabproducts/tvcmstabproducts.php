...
class TvcmsTabProducts extends Module
{
    ...
    public function createDefaultData()
    {
        ...
        foreach ($languages as $lang) {
            $result['TVCMSTABPRODUCTS_NEW_PROD_TITLE'][$lang['id_lang']] = 'Latest';
            ...
            $result['TVCMSTABPRODUCTS_SPECIAL_PROD_TITLE'][$lang['id_lang']] = 'Special';
            ...
            $result['TVCMSTABPRODUCTS_FEATURED_PROD_TITLE'][$lang['id_lang']] = 'Featured';
            ...
            $result['TVCMSTABPRODUCTS_BEST_SELLER_PROD_TITLE'][$lang['id_lang']] = 'Best Seller';
        ...
        Configuration::updateValue('TVCMSTABPRODUCTS_SPECIAL_PROD_IMAGE_SIDE', 'right');
