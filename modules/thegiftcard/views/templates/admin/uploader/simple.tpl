...
<div class="row">
	<div class="alert alert-warning">{l s='You have reached the limit (%s) of files to upload, please remove files to continue uploading' sprintf=$max_files mod='thegiftcard'}</div>
</div>
{else}
<div class="form-group">
	<div class="col-sm-6">
