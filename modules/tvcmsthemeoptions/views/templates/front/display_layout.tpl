                                        ...
                                        <div id="headerMobileLayout" class="collapse" aria-labelledby="headermobileWrapper" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="tvtheme-layout-radio">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="tvlayout-radio-img">
                                                            <input type="radio" class="header-mobile-layout" name="header-mobile-layout" value="{$i}" {if $smarty.foreach.index.index+1==1}checked{/if} />
                                        ...
                                        <div id="productLayout" class="collapse" aria-labelledby="productWrapper" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="tvtheme-layout-radio">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="tvlayout-radio-img">
                                                            <input type="radio" name="product-layout" name="product-layout" value="{$i}" {if $smarty.foreach.index.index+1==1}checked{/if} />
