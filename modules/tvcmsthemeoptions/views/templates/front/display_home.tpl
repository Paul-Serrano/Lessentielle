                                    ...
                                    <label for="radioTheme1" class="theme-1">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#c9a654;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                    {* </g> *}
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#c9a654;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                    {* </g> *}
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 1' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme2" name="radioTheme" data-color="#ff8961" data-color-two="#ff8961" value="theme2">
                                    <label for="radioTheme2" class="theme-2">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#ff8961;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                    {* </g> *}
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#ff8961;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                    {* </g> *}
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 2' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme3" name="radioTheme" data-color="#fd779a" data-color-two="#fd779a" value="theme3">
                                    <label for="radioTheme3" class="theme-3">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#fd779a;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                    {* </g> *}
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#fd779a;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                    {* </g> *}
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 3' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme4" name="radioTheme" data-color="#adb903" data-color-two="#adb903" value="theme4">
                                    <label for="radioTheme4" class="theme-4">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#adb903;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                    {* </g> *}
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                {* <g> *}
                                                    <polygon style="fill:#adb903;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                    {* </g> *}
                                            </svg>
                                        </span>
