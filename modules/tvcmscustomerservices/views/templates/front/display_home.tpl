                                        ...
                                        <div class="tvservices-wrapper">
                                            <div class="tvservices-img-conut">
                                                <div class='tvservices-img'>
                                                   ...
                                                   {* <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_1.image}" class="tv-img-responsive" width="50" height="50" alt="{$dis_arr_result.data.service_1.title}" loading="lazy" /> *}
                                                </div>
                                    ...
                                    <div class="tvservices-2 tvall-services-block">
                                        <div class="tvservices-wrapper">
                                            <div class="tvservices-img-conut">
                                                <div class='tvservices-img'>
                                                     <i class='material-icons'>&#xe8b1;</i>
                                                   {* <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_2.image}" class="tv-img-responsive" width="50" height="50" alt="{$dis_arr_result.data.service_2.title}" loading="lazy" /> *}
                                                </div>
                                                {*
                                                <div class='tvservices-count'>
                                    ...
                                    <div class="tvservices-3 tvall-services-block">
                                        <div class="tvservices-wrapper">
                                            <div class="tvservices-img-conut">
                                                <div class='tvservices-img'>
                                                     <i class='material-icons'>&#xe850;</i>
                                                   {* <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_3.image}" width="50" height="50" class="tv-img-responsive" alt="{$dis_arr_result.data.service_3.title}" loading="lazy" /> *}
                                                </div>
                                                {*
                                                <div class='tvservices-count'>
