        ...
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="row tvcmsdesktop-top-header-box">
                    ...
                    <div class='col-xl-4 col-lg-2 col-md-4 col-sm-12 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 tvcmsheader-nav-right">
                        <div class="ttvcms-wishlist-icon">
                            {if $withData}
                            {hook h='displayNavWishlistBlock'}
                            {/if}
                        </div>
                        <div class="tvheader-compare">
                            {if $withData}
                            {hook h='displayNavProductCompareBlock'}
                            {/if}
                        </div>
