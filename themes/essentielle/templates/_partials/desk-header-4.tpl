        ...
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="row tvcmsdesktop-top-header-box">
                    <div class='col-xl-2 col-lg-2 col-md-2 col-sm-12 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 tvcms-header-menu-offer-wrapper tvcmsheader-sticky">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 tvcmsheader-nav-right">
