 ...
 *}
{strip}
<div class="tvcms-newsletter-wrapper links col-xl-3 col-lg-3 col-md-12">
	<div class="tvcms-newsletter-inner">
		<div class="block_newsletter tv-newsletter-wrapeer">
			<div class="tvnewsletter-block">
				<div class="{*tvnewsletter-lable-wrapper*}  tvfooter-title-wrapper" data-target="#footer_sub_menu_newsletter" data-toggle="collapse">
					{if Configuration::get('TVCMSCUSTOMSETTING_NEWSLETTER_TITLE', $language.id)}
						<p id="block-newsletter-label" class="{*tvnewsletter-title*} tvfooter-title">
